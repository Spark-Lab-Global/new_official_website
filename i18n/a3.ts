const a3 = {
  zh: {
    ...
    "a3.thesis1.description": `Spark，不是一时的激情，而是探索的副产物，和自我发现的结果。 
...
`,
    ...
    "a3.thesis2.description": `真正持久的动力，来自于对内心使命感的发现。
创业不仅仅是解决市场问题，
...
`,
    ...
    "a3.thesis3.description": `A spark never appears out of nowhere.
It needs space to be allowed,
Room for detours, trial and error, and honest reflection.

What we truly lack is a real and free environment:
